...
import VisitedCountries from '../VisitedCountry'
...
class CountryList extends Component {
  state = {isActive: false, listOfCountries: initialCountriesList}
  ...
  render() {
    const {isActive, listOfCountries} = this.state
    ...
    return (
      <MainContainer>
        ...
        <div>{this.renderVisitedCountriesList()}</div>
      </MainContainer>
    )
  }
}
